    ...
    return(
        <Container fluid>
            <Row style={{backgroundColor:'#ffff'}}>
                ...
                <Button style={{backgroundColor:'#f7c7c7', color:'#B3261E', borderRadius: '15px'}} href="/request">Request Blood</Button> <Button style={{backgroundColor:'#f7c7c7', color:'#B3261E', borderRadius: '15px'}} href="/donate">Donate Blood</Button>
