...
const DonationCenter = () => {
  ...
  return (
    <>
      <Row className="text-center justify-content-center mb-4" style={{ padding: '40px 0' }}>
        <Col md="8">
      ...
      <Row className="gx-3 gy-3 justify-content-center mt-4">
        <Col md="6">
        ...
        <Col md="5">
          ...
          <Card style={{ borderRadius: "20px", backgroundColor: "#bcd9db" }}>
            <CardBody>
              ...
              {/* You can replace this section dynamically from backend as well */}
              <p><strong>Hospital Name:</strong> Sultan Qaboos Hospital</p>
